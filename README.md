...
- **Add a score to a list of scores**
...
- [Live Demo Link](https://rosemutai.github.io/Leaderboard/)
...
Go to github and find the repository with Leaderboard
...
```sh
  cd my-folder
  git clone git@github.com:rosemutai/Leaderboard.git
```
--->
### Install
...
Example:
```sh
git@github.com:rosemutai/Leaderboard.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [https://github.com/rosemutai/Leaderboard/issues.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
